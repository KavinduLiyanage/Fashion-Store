...
//This Component is used to edit Customer Details
export default class UserEdit extends React.Component {
  ...
  onSubmit(e) {
    ...
    if (this.state.password === this.state.conPassword) {
      ...
      axios
        .post(
          serverUrl + "/users/update/" + localStorage.getItem(TOKEN_ID),
          users
        )
        .then((response) => {
                    ...
                    <div className="form-group">
                      <label className="radio-inline">
                        ...
                        <input
                          ...
                          value="Male"
                          checked={
                            localStorage.getItem(TOKEN_GENDER) === "Male"
                          }
                          onChange={(e) =>
                      ...
                      <label className="radio-inline">
                        ...
                        <input
                          ...
                          value="Female"
                          checked={
                            localStorage.getItem(TOKEN_GENDER) === "Female"
                          }
                          onChange={(e) =>
                            this.updateInput("gender", e.target.value)
                          }
