                        ...
                        <div className="d-flex justify-content-center h-100">
                            <div className="card">
                                <div className="card-header">
                                    <h3>Edit Store Manager Details</h3>
                                </div>
                                    ...
                                    <form onSubmit={this.onSubmit}>
                                        ...
                                        <div className="input-group form-group">
                                            ...
                                            <input type="text" className="form-control" placeholder="First Name"
                                                   value={this.state.firstName} onChange={e => this.updateInput("firstName",e.target.value)} required/>
                                        </div>
                                        ...
                                        <div className="input-group form-group">
                                            ...
                                            <input type="text" className="form-control" placeholder="Last Name"
                                                   value={this.state.lastName} onChange={e => this.updateInput("lastName",e.target.value)} required/>
                                        </div>
                                        ...
                                        <div className="input-group form-group">
                                            ...
                                            <input type="text" className="form-control" placeholder="Phone No"
                                                   value={this.state.phoneNo} onChange={e => this.updateInput("phoneNo",e.target.value)} required/>
                                        </div>
                                        ...
                                        <div className="input-group form-group">
                                            ...
                                            <input type="password" className="form-control" placeholder="Confirm Password"
                                                   value={this.state.conPassword} onChange={e => this.updateInput("conPassword",e.target.value)} required/>
                                        </div>
                                        <label className="control-label">Address</label>
                                        <div className="input-group form-group">
                                            <div className="input-group-prepend">
                                                <span className="input-group-text"><i className="fas fa-map" /></span>
                                            </div>
                                            <textarea placeholder="Address" rows="1" className="form-control"
                                                      value={this.state.address} onChange={e => this.updateInput("address",e.target.value)} required/>
                                        </div>
                                        <label className="control-label">Gender</label>
                                        <div className="form-group">
                                            <label className="radio-inline">
                                                <div className="input-group-prepend" style={{"display": "inline"}}>
