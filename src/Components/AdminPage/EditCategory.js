...
//This class is used to edit category details
export default class EditCategory extends React.Component {
  ...
  componentDidMount() {
    axios
      .get(serverUrl + "/category/" + this.props.match.params.id)
      .then((response) => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        serverUrl + "/category/update/" + this.props.match.params.id,
        category
      )
      .then((response) => {
                  ...
                  <form onSubmit={this.onSubmit}>
                    ...
                    <div className="input-group form-group">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          this.updateInput("categoryName", e.target.value)
                        }
                        required
                      />
                    </div>
