...
export default class ProductDetails extends Component {
  ...
  componentDidMount() {
    axios
      .get(serverUrl + "/comment/commentDetails/" + this.props.match.params.id)
      .then((response) => {
    ...
    axios
      .get(serverUrl + "/product/productDetails/" + this.props.match.params.id)
  ...
  addWishList(
    ...
    axios
      .post(serverUrl + "/wish/addWishItem", obj)
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-6 col-md-8">
            ...
            <div className="bg-light" style={{ width: "150px" }}>
              <h5 className="text-warning">Discount {this.state.discount}%</h5>
            </div>
            <br />
            <div>
              <h6>Description</h6>
        ...
        <div className="row">
          <div className="col-md-12">
            <h4>User Reviews</h4>
            <div style={{ border: "2px solid hsl(0, 0%, 70%)" }}>
              <div>
